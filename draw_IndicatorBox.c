...
#define	idct_font_width		4
#define	idct_font_height	5
...
void draw_IndicatorBox(u8g2_t *u8g2, uint8_t x, uint8_t y, uint8_t width, uint8_t height, uint8_t color, const char *str){
	...
	str_offset = ( (width - StrLength(str)*idct_font_width)>>1 ) + 1;
	u8g2_DrawStr(u8g2, x+str_offset, y+(height-(idct_font_height>>1)), str);
